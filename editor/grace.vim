...
syn keyword graceKeywords import export class if else for in by while break continue return end this print println eprint eprintln and or func instanceof isobject assert try catch throw typename skipwhite
